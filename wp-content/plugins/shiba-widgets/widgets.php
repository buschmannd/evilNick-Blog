...
if (isset($options['lost_widgets'])) {
	register_sidebar(array(
		'name' => __('Lost Widgets'),
		'id' => 'wp_lost_widgets',
		'description' => '',
		'before_widget' => '',
		'after_widget' => '',
	...
	$sidebars_widgets['wp_lost_widgets'] = $lost_widgets;
...
<div id="widgets-left">
    ...
    <style>
	#wp_lost_widgets .widget {
		overflow:hidden;
		width:250px; float: left; 
		margin: 0px 10px 20px;
	}
	#wp_lost_widgets{padding:5px 5px 0;}
	#wp_lost_widgets .widget-placeholder{margin:0 10px 20px;float:left;}
	#wp_lost_widgets .widget-control-edit .edit{display:inline;}
	</style>	
 	<div class="widgets-holder-wrap">
		<div class="sidebar-name">
		<div class="sidebar-name-arrow"><br /></div>
		<h3><?php _e('Lost Widgets'); ?>
		<span><img src="images/wpspin_light.gif" class="ajax-feedback" title="" alt="" /></span></h3></div>
		<div class="widget-holder inactive">
		<p class="description"><?php _e('Widgets not assigned to any sidebars.'); ?></p>
		<?php wp_list_widget_controls('wp_lost_widgets'); ?>
		<br class="clear" />
		</div>
	</div>
 	<?php endif; ?>   
